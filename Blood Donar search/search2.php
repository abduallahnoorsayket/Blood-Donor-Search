...
<td><input type="text" name="area_name" placeholder="enter your area" required="required"/> </td>
</tr> 
...
<td><input type="text" name="blood" placeholder="enter blood gooup" required="required"/> </td>
</tr>
