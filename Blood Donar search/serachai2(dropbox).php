...
<form action="serachai2(dropbox).php" method="POST" enctype="multipart/form-data">
...
<td><input type="text" name="blood" placeholder="enter blood group" required="required"/> </td>
</tr>
